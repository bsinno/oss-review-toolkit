...
import org.ossreviewtoolkit.reporter.model.AmazonOssAttributionBuilderService
...
class AmazonOssAttributionBuilderReporter : Reporter {
    ...
    override fun generateReport(outputStream: OutputStream, input: ReporterInput) {
        ...
        requireNotNull(rootProject) {
            "The ORT result must contain exactly one project."
        }
        ...
        try {
            ...
            dependencies.forEach { id ->
                ...
                //       If the package was modified is something that is not currently capture by ORT. Think about
